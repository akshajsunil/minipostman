...
form.addEventListener('submit',e => {
    ...
    axios({
        ...
        params: createKeyValuePairToObject(queryParamsContainer),
        headers: createKeyValuePairToObject(requestHeadersContainer),
        data,
    })
    .catch(e => e)
.then(response => {
...
function createKeyValuePairToObject(container) {
